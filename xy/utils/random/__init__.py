...
class Random:
    ...
    def shuffle_string(self, string: str, factor: Optional[Callable]) -> str:
        """ 获取乱序字符串 """
        return "".join(self.shuffle(list(string), factor))

    def shuffle(self, obj: Union[list, bytearray, str], factor: Optional[Callable] = None, copy_type: int = 0):
        """
        :param obj: 可迭代参数
