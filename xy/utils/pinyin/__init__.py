...
class PinYin:
    def __init__(self, hans):
        self.__hans = hans

    def get_origin_bopomofo_array(self, style=Style.NORMAL, heteronym=True):
        """ 输出原生全拼 """
        return pinyin(self.__hans, style=style, heteronym=heteronym)

    def get_origin_logogram_array(self, style=Style.FIRST_LETTER, heteronym=True):
        """ 输出原生简拼 """
        return pinyin(self.__hans, style=style, heteronym=heteronym)

    def to_bopomofo_array(self, style=Style.NORMAL, heteronym=True):
        """ 输出遍历原生全拼矩阵 """
    ...
    def to_logogram_array(self, style=Style.FIRST_LETTER, heteronym=True):
        """ 输出遍历原生简拼矩阵 """
