...
class Test_AES:
    def setup_class(self):
        self.__text = "AES测试文本！".encode("utf-8")
        key = "abcdefgh12345678".encode("utf-8")
        iv = key[::-1]
        self.aes_ecb_0 = AES(key, cipher_method="MODE_ECB", code_method="base64")
        self.aes_ecb_1 = AES(key, cipher_method="MODE_ECB", pad_method="PKCS5Padding", code_method="base64")
        self.aes_ecb_2 = AES(key, cipher_method="MODE_ECB", pad_method="PKCS5Padding", code_method="hex")
        self.aes_cbc_0 = AES(key, iv=AES().new_random_iv(), cipher_method="MODE_CBC", code_method="base64")
        self.aes_cbc_1 = AES(key, iv=iv, cipher_method="MODE_CBC", code_method="base64")
        self.aes_cbc_2 = AES(key, iv=iv, cipher_method="MODE_CBC", pad_method="PKCS5Padding", code_method="base64")
    ...
    def test_ecb_2(self):
        encrypt_text = "74c702412d8457bd74b33366413b78e260d9c4e3b7f537f83f1f6efbc138ad2f".encode("utf-8")
    ...
    def test_cbc_3(self):
        encrypt_text = "c77bb3749d7ed69d082703e628eb23e662b6afd6708f9ea4f69f44c5ba2c1ca8".encode("utf-8")
